          ...
          <div className="bg-card/90 rounded-[1.95rem] px-8 py-10 md:px-12 md:py-14 border border-white/10 flex flex-col items-center text-center">
            ...
            <div className="space-y-4 mb-8">
              <div className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded-full bg-primary/10 border border-primary/20 text-primary">
                ...
                <span className="text-[9px] font-bold tracking-[0.2em] uppercase">Join HopeLink</span>
              </div>
              
              <h1 className="text-3xl md:text-4xl font-black tracking-tighter">
                Create your <span className="text-primary underline underline-offset-4 decoration-primary/20">Impact</span>
              </h1>
              
              <TypographyMuted className="text-sm md:text-base leading-relaxed opacity-80">
                Become part of our global humanitarian community.
              </TypographyMuted>
            </div>
            ...
            <div className="mt-8 flex items-center justify-center gap-1.5 text-[9px] font-bold uppercase tracking-widest text-muted-foreground opacity-50">
              ...
              <span>Secure & Verified Environment</span>
            </div>
            
            <div className="mt-6 text-[9px] text-muted-foreground leading-relaxed max-w-[200px] opacity-40">
              By joining, you agree to our <Link className="underline hover:text-primary" href="/terms-of-service">Terms</Link> & <Link className="underline hover:text-primary" href="/privacy-policy">Privacy</Link>.
            </div>
          </div>
        </div>
      </div>
