      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-[0.9] flex items-center gap-4">
            Community <span className="text-primary">Directory</span>
            <Users className="size-10 md:size-14 text-muted-foreground/20 shrink-0" />
          </h1>
          <TypographyMuted className="text-lg md:text-xl font-medium tracking-tight opacity-70 max-w-2xl">
            A comprehensive overview of all registered members within the HopeLink ecosystem.
          </TypographyMuted>
        </div>
      </div>
